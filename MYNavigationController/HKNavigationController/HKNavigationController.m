...
NSString *const PanGecognizerNavigationControllerNotification = @"PanGecognizerNavigationControllerNotification";
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    viewController.enablePopGestureRecognizer = viewController.hk_navigationController.fullScreenPopGestureEnabled;
...
- (void)viewDidLoad {
    ...
    self.popPanGesture.maximumNumberOfTouches = 1;
     ...
     [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(enablePanGecognizer:) name:PanGecognizerNavigationControllerNotification object:nil];
}

- (void)enablePanGecognizer:(NSNotification *)notification {
