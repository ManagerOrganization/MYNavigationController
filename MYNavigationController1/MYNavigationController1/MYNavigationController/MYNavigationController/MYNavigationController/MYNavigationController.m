...
typedef NS_ENUM(NSUInteger, MYNavigationPanDirection) {
    MYNavigationPanDirectionNone,
    MYNavigationPanDirectionLeft,
    MYNavigationPanDirectionRight,
};
...
- (void)gestureRecognizerDidPan:(UIPanGestureRecognizer*)panGesture {
    ...
    MYNavigationPanDirection panDirection = MYNavigationPanDirectionNone;
    CGPoint vel = [panGesture velocityInView:self.view];
    
    if (vel.x > 0) {
        panDirection = MYNavigationPanDirectionRight;
    } else {
        panDirection = MYNavigationPanDirectionLeft;
    }
...
- (void)completeSlidingAnimationWithDirection:(MYNavigationPanDirection)direction {
    
    if (direction == MYNavigationPanDirectionRight){
...
- (void)pushViewController:(UIViewController *)viewController completion:(MYNavigationControllerCompletionBlock)completion {
